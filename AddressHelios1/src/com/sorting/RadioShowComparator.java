...
/**
 * Sorts the radio based on the number of archive listens
 * @author User
 *
 */
public class RadioShowComparator implements Comparator{
	 ...
	 */
	public RadioShowComparator(SortEnum theEnum) {
		this.sort=theEnum;
	}
	/**
	 ...
	 */
	  ...
	  private int sortAsc(Object rShow1, Object rShow2) {
		  int retVal=0;
	        ...
	        int listens1=show1.getArchiveListens();
	        int listens2=show2.getArchiveListens();
