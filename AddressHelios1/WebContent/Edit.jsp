...
<title>Edit</title>
		...
		#resizable1 { width: 99%; height: 20px; padding: 0.5em;}
		...
		*/
		...
		/*
		* Opens the delete jsp in its own window
		* @param showId - the id to the radio show in the database
		* @param title - the title of the radio show		
		*/		
		function displayWindowForDelete(showId,title) {
			// Build the URL to the action that prepares the JSP which prompts for the delete
			var theURL="Radio.do?method=deleteprep&radioid="+showId+"&title="+title;
			
			// Open the window and prompt the user
			window.open(theURL,'Delete Radio Show','width=400,height=200,left=600,top=200');
		}
		</script>
</head>
<body style="font-size:62.5%;" >
        <div style="color:red">
 		...
 		<table class="customersnowidth" align="center" width="90%">
 			<tr>
 				<th>
			  		
					Contact and Radio Show Information
 							...
 							<div style="height: 300px; overflow: auto;">
				 				<table class="customersnowidth"  align="center" width="100%">
									...
									<tr>										
										...
										<th>
											<a href="Radio.do?method=sortRadioShowLive">Live</a>
										</th>										
										<th>
									...
									<tr bgcolor="white">
										 <td nowrap="nowrap">
										 	<a href="#" onclick="displayWindowForDelete('<bean:write name="listUserId" property="showId"/>', '<bean:write name="listUserId" property="title"/>')" >
										 	<img src="images/deletesmall.jpg" />
										 	</a>
