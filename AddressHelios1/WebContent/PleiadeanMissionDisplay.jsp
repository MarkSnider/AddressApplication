...
<%@ page import="com.actions.PleiadeanMissionAction, com.forms.SearchContact251Form" %>
<html:html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Pleiadian Mission Display Like</title>
<script type="text/javascript" >
	...
	function submitForm()
	{
		document.forms[0].action = "displayPleiadean.do?method=search";
		document.forms[0].submit();
	}	
	function viewLineInfo(line) {
		
		// set the URL to point to the action
		var targetUrl="displayPleiadean.do?method=expand&linenumber="+line;
	    ...
	    // Go to the URL to display the expand JSP
...
<body>
	...
	<h3>Pleiadean Mission Display Like</h3>
	   <html:form action="/displayPleiadean" >
